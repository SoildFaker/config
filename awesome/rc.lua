...
globalkeys = awful.util.table.join(
    ...
    -- launch app
    awful.key({ modkey, "Control" }, "t", function () awful.util.spawn_with_shell(terminal) end),
    ...
    -- {{{Fn control
      ...
      awful.key({ }, "XF86AudioLowerVolume", function()
         awful.util.spawn("amixer set Master 2%-", false)
         helpers:delay(myvolume.update, 0.1)      end),
